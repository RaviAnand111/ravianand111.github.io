...
jQuery(document).ready(function(){
	...
	var calculate3 = function(){
		...
		var b_url = 'https://akdesigner.com/whmcs-templates/index.php?systpl=Yogastic-Host&cmd=cart&action=add&disk='+disk_link_arr3[DiskSlider_val]+'&ram='+ram_link_arr3[RamSlider_val]+'&cpu='+cpu_link_arr3[CpuSlider_val];
