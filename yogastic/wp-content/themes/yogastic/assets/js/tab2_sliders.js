...
jQuery(document).ready(function(){
	...
	var calculate2 = function(){
		...
		var b_url = 'https://akdesigner.com/whmcs-templates/index.php?systpl=Yogastic-Host&cmd=cart&action=add&disk='+disk_link_arr2[DiskSlider_val]+'&ram='+ram_link_arr2[RamSlider_val]+'&cpu='+cpu_link_arr2[CpuSlider_val];
